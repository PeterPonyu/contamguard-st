...
from contamguard_st.claim_status import (
    graduation_claim_status,
    graduation_claim_status_line,
    graduation_evidence,
    missing_evidence,
    signed_robust_modest_review,
    validation_marker_approved,
)
from contamguard_st.contracts import ClaimStatus
...
class ClaimStatusIntegrityTests(unittest.TestCase):
    def test_public_status_is_evidence_derived_preliminary(self):
        ...
        self.assertFalse(signed_robust_modest_review())
