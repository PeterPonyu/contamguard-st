...
PATTERN='3d-?ot|aether-?3d|aether3d|bento|cellniche|deepspatial|factorgraph-?st|factorgraphst|foundation-?st-?parity|foundationstparity|gpsfish|harvest|inspire|lumina-?st|luminast|moleculepoint|niche-?lens|nicheflow|nicheformer|nichelens|paneloracle|path2space|pathscope|perturbcausal|sccomm|sceptre|scgpd|scomm|smoppix|spagrn|spaim|spatial-?regulatory-?graph|spatialperturbseq|spatialregulatorygraph|spatiotemporal-?niche|spatiotemporalniche|spatrace|stimage|stories|stpainter|vista|xenium_analysis_pipeline'
